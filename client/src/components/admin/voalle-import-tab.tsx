    ...
    try {
      ...
      for (const tag of contractTags) {
        ...
        const link: ParsedLink = {
          ...
          slotOlt: conexao?.['Slot OLT'] ? parseInt(conexao['Slot OLT']) : (authContract?.slot_olt != null && authContract.slot_olt !== '' ? parseInt(String(authContract.slot_olt)) : null),
          portOlt: conexao?.['Porta OLT'] ? parseInt(conexao['Porta OLT']) : (authContract?.port_olt != null && authContract.port_olt !== '' ? parseInt(String(authContract.port_olt)) : null),
      ...
      const response = await apiRequest("POST", "/api/admin/voalle-import-equipment", {
        concentrators: concentrators.map(c => {
          ...
          return {
            ...
            voalle_access_point_ids: n.voalle_access_point_ids || n.ids_ponto_de_acesso || n.access_point_ids || '',
          };
        }),
